...
// Replace zerostep, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= zerostep — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining zerostep for
...
* Upstream: https://github.com/hyperpolymath/zerostep/issues
