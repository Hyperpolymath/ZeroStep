...
// Replace zerostep, Zerostep — See README.adoc for details., just run, Zerostep started successfully. with actuals
= zerostep — Quick Start for Users
:toc:
:toclevels: 2

== What is zerostep?

Zerostep — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./zerostep-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/zerostep/wiki
